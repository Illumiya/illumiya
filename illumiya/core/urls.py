...
urlpatterns = [
    ...
    path('course/<int:pk>/<int:topic>/', views.CourseDetailView.as_view(), name='course-detail-main-topic'),
    path('course/<int:pk>/<int:topic>/<int:subtopic>/', views.CourseDetailView.as_view(),
         name='course-detail-sub-topic'),
